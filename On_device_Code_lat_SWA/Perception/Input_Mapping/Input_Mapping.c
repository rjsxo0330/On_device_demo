...
void Input_Mapping(void)
{
    ...
    Logic_SWA_Angle               = ECAN_SWA_Angle;                                                             /* Use: steering angle signal for lateral logic. */
    ...
    Logic_LKS_ON_OFF_SEND         = ScenarioCAN_LKS_ON_OFF_SEND;                                                /* Use: LaneKeepingController() on/off logic. */
